# Revising for November GCSE Resits: What the Next Ten Weeks Should Look Like
...
## Why November GCSE resit revision is not a repeat of last year

First time round you were learning content and learning how to sit the exam at the same time, across nine or ten subjects, in the same few weeks. Now you have one or two subjects, you have seen the paper format for real, and you already half know the material.

Half known is an awkward place to be. It feels like you know it, right up until the moment you have to produce it under timing, which is why re-reading your old notes is such a comfortable and useless way to spend an evening. It also means that starting from page one of the textbook burns six of your ten weeks on material you already have. What you are short of is not the content. It is the handful of specific gaps.

So the whole plan below is built backwards from one question: what exactly went wrong, and where?


## Two dates to get in your phone before you do anything else
...
## Weeks seven and eight: papers, timed, no negotiation

Two papers a week, full length, timed, phone in another room. Mark them honestly against the scheme, and when the mark scheme wants something you did not write, work out whether that is a knowledge gap or a wording gap.

This block is also where you fix pacing, which is the single most common reason people who know the content still drop marks. Write your time targets on the front of the paper before you start. If you are still overrunning by paper three, the problem is that you are perfecting question two instead of attempting question ten. The fix is a rule about the clock: when it hits your target for that question, you move, finished or not.
...
- Re-reading notes. Feels productive, does nothing. If you are not producing something from memory, it is not revision.

- Starting at the beginning. You are not doing the course again. You are patching a list.

- Topics you were already reliable on. Fifteen minutes a fortnight to keep them warm, not a Sunday.

- Rewriting notes in nicer handwriting. You know.

Doing both subjects? Alternate days instead of splitting each evening in half. Give maths the majority of the fixing block, since it has more discrete content to patch, and give English more of weeks seven and eight, since it improves mostly through timed writing.

Ten weeks with a list is a lot. Ten weeks without one disappears. Get the entry confirmed this week and sit one cold paper, and by next weekend you will know exactly what the other nine weeks are for. You have already sat this paper once. That is a real advantage. Use it.

GCSE Boss maps all 174 GCSE specifications across the five UK exam boards, so you can point revision at the exact spec points you dropped marks on rather than at a generic topic list. Have a look at the subjects page. GCSE Boss is not affiliated with or endorsed by any exam board. We map their published specifications so students can revise exactly what is in their syllabus.
